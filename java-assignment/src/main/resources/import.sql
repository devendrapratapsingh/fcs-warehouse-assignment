...
-- Sample fulfillment associations (Warehouse → Product → Store)
INSERT INTO warehouse_fulfillment(id, warehouseBusinessUnitCode, productId, storeId) VALUES (1, 'MWH.001', 1, 1);
INSERT INTO warehouse_fulfillment(id, warehouseBusinessUnitCode, productId, storeId) VALUES (2, 'MWH.001', 2, 1);
ALTER SEQUENCE warehouse_fulfillment_seq RESTART WITH 3;
